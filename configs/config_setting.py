...
class setting_config:
    ...
    def add_argument_config(cls):
        ...
        if args.work_dir is None:
            args.work_dir = '/mnt/data/ljc/results_Mul_X_asc_c/'+ args.datasets_name + '/' +  datetime.now().strftime('%Y_%B_%d_%Hh_%Mm') + '/'
    ...
    def set_datasets(cls):
        if cls.datasets_name == 'isic2017':
            cls.data_path = '/mnt/data/ljc/data/ISIC2017/'
            cls.datasets = isic_loader
            cls.criterion = BceDiceLoss()
        elif cls.datasets_name == 'isic2018':
            cls.data_path = '/mnt/data/ljc/data/ISIC2018/'
            cls.datasets = isic_loader
            cls.criterion = BceDiceLoss()
        elif cls.datasets_name == 'synapse':
            cls.data_path = '/mnt/data/ljc/data/Synapse/train_npz/'
            cls.datasets = Synapse_dataset
            cls.list_dir = '/mnt/data/ljc/VM-UNet-mamba1/lists/lists_Synapse/'
            cls.volume_path = '/mnt/data/ljc/data/Synapse/test_vol_h5/'
            cls.model_config['num_classes'] = 9
            cls.criterion = CeDiceLoss(9, cls.loss_weight)
        elif cls.datasets_name == 'acdc':
            cls.data_path = '/mnt/data/ljc/data/ACDC/'
            cls.datasets = ACDC_dataset
            cls.list_dir = '/mnt/data/ljc/VM-UNet-baseline/lists/lists_ACDC/'
            cls.volume_path = '/mnt/data/ljc/data/ACDC/test/'
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': '/mnt/data/ljc/VM-UNet-mamba1_2/pre_trained_weights/vmamba_small_e238_ema.pth',
    }
